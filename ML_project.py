...
with tab1:
    ...
    st.text_area(":rainbow[Project created by]","MOHAN RAM.N,     contact:mohanramnanda0305@gmail.com")
...
with tab2:
    ...
    with open("F:/breast_cancer_prediction/classification_model.pk1","rb") as f_:
          Classi_model=pickle.load(f_)

    with open("F:/breast_cancer_prediction/classification_scale.pk1","rb") as f_1:
